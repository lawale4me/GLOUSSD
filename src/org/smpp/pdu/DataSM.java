...
public class DataSM extends Request {
	...
	private byte dataCoding = Data.DFLT_DATA_CODING;
        private short smLength = Data.DFLT_MSG_LEN;//newly added
        //private ShortMessage shortMessage = new ShortMessage(Data.SM_MSG_LEN);//newly added
        //private byte ussdServiceOp = Data.;
	...
	private TLVString messagePayloadOutGoing =
		new TLVString(Data.OPT_PAR_MSG_PAYLOAD, Data.OPT_PAR_MSG_PAYLOAD_MIN, Data.OPT_PAR_MSG_PAYLOAD_MAX);
	...
	public DataSM() {
		...
		registerOptional(payloadType);
                ...
                registerOptional(messagePayloadOutGoing);		
...
//                setSmLength(decodeUnsigned(buffer.removeByte()));//newly added
//                shortMessage.setData(buffer.removeBuffer(getSmLength()));//newly added
	}
...
//                buffer.appendBuffer(shortMessage.getData());//newly added
//                buffer.appendByte(encodeUnsigned(getSmLength()));//newly added
	...
	public boolean hasMessagePayloadOutgoing() {
		return messagePayloadOutGoing.hasValue();
	}
	...
	public void setMessagePayloadOutGoing(String value) throws WrongLengthException {
		messagePayloadOutGoing.setValue(value);
	}
	...
	public String getMessagePayloadOutGoing() throws ValueNotSetException {
		return messagePayloadOutGoing.getValue();
	}
